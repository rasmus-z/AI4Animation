...
namespace SIGGRAPH_2017 {
	public class BioAnimation_ARKit : MonoBehaviour {
...
//}
	...
	#if UNITY_EDITOR
	[CustomEditor(typeof(BioAnimation_ARKit))]
	public class BioAnimation_ARKit_Editor : Editor {

			public BioAnimation_ARKit Target;

			void Awake() {
				Target = (BioAnimation_ARKit)target;
			}
